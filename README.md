<p align="center">
  <img src="build/appicon.png" alt="Soteria" width="112">
</p>
...
<p align="center">
  <a href="LICENSE"><img alt="License: GPL-3.0" src="https://img.shields.io/github/license/blogic-kietle/BStorage?color=1B1A17&label=license"></a>
  <a href="https://github.com/blogic-kietle/BStorage/releases"><img alt="Latest release" src="https://img.shields.io/github/v/release/blogic-kietle/BStorage?include_prereleases&label=release&color=2E64C8"></a>
...
Soteria is in active development. Builds for each release are on the [Releases](https://github.com/blogic-kietle/BStorage/releases) page.
...
- The source is open under the GPL-3.0, so all of the above can be checked.
...
Ideas and votes belong in [Issues](https://github.com/blogic-kietle/BStorage/issues).
...
```bash
git clone https://github.com/blogic-kietle/BStorage.git soteria
...
Soteria is free software, released under the [GNU General Public License v3.0](LICENSE).
...
<p align="center"><sub>Made by ZenSoftware</sub></p>
